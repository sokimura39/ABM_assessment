...
Observations were made at the natural state, defined in @tbl-naturalstate.

| Model | Definition of natural state |
| --- | --- |
| Sugarscape 2 | 100 ticks after the last death of turtle |
| Sugarscape 3 | Observation window of 2 to 5 maximum lifespan lengths (100 ticks) after start |
...
A significant drop of survival rate is observed for maximum metabolism of 6 and above. Given that the maximum amount of sugar supplied by a patch in Sugarscape is 4, all turtles with metabolism values over 4 do not survive until the natural state.
