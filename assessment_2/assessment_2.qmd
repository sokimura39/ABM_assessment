...
| `price` | The property price of building unit at patch. Assumed to be linear with height, calculated as `pycor + 1` |
| `shadow` | The strength of shadow cast by tall buildings on the south. Shadows are simulated to be more intense according to the distance to the top of shadow. |
...
| `open-space` | The number of open space the building unit has access to. A unit has access to open spaces within `open-range` cells horizontally. |
